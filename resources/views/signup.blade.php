...
<div class="positive-relative">
    ...
    <div class="formko container d-flex align-items-center justify-content-center ">
        <form action="{{route('signupUser')}}" class="border border-dark p-4 m-0" method="post">
            @csrf
            <div class="mb-3">
                <label for="username" class="form-label">Username</label>
                <input type="username" class="form-control @error('username') is-invalid @enderror" id="username"
                    name="username">
                <div id="usernameerror" class="form-text">@error('username') {{$message}} @enderror</div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control @error('password') is-invalid @enderror" id="password"
                    name="password">
                <div id="password" class="form-text">@error('password') {{$message}} @enderror</div>

            </div>
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input">
                <label class="form-check-label">I agree with the terms of license and
                    agreement</label>
            </div>
